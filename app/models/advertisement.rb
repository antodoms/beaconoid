class Advertisement < ActiveRecord::Base
  ...
  has_attached_file :image, styles: { medium: "300x300>", thumb: "100x100>" }, default_url: "//s3-ap-southeast-2.amazonaws.com/beaconoid/default.jpg", :path => "#{Rails.env}/image/:id/:filename"
